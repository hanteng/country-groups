...
# Data source 
URL_ = "http://www.acp.int/content/secretariat-acp"
...
# Xpath extraction
_xpath='//*[@id="node-10"]/div/div/div[1]/div[1]/div/p[9]/text()'
...
list_country_names_Web = [x.strip() for x in t.xpath(_xpath)[0].split('-')] #special treatment here
