...
# Data source 
URL_ = "http://www.tein.asia/tein4/partners/contact.do"
...
# Xpath extraction
_xpath='//*[@id="sub_wrap"]/div[2]/table/tbody/tr/td[2]/span/text()'
...
list_country_names_Web = t.xpath(_xpath) + ['TW'] # Based on the network map http://www.tein.asia/tein4/network/maps.do  TW is included and 24 listed
