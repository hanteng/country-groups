# -*- coding: utf-8 -*-
#歧視無邊，回頭是岸。鍵起鍵落，情真情幻。
# Correction: 11 Republic of the Congo-->  CG;  37 Republic Arab Saharawi Democratic  --> EH ; 38 --> ST; 42 --> SO; 43--> ZA
import os.path, glob
import requests
...
# Xpath extraction
_xpath = '//*[@id="tabs5-pane11"]/div/div[1]/div/ul/li[2]/ul/li/a/img/@title|//*[@id="tabs5-pane11"]/div/div[2]/div/ul/ul/li/text()'
...
list_country_names_Web = [x.strip() for x in t.xpath(_xpath)] 
