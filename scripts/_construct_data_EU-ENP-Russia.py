# -*- coding: utf-8 -*-
#歧視無邊，回頭是岸。鍵起鍵落，情真情幻。
# Correction: 14 Democratic Republic of the Congo--> CD, 15 Republic of the Congo-->  CG
import os.path, glob
import requests
...
# Data source 
URL_ = "https://ec.europa.eu/europeaid/countries/neighbourhood-countries_en"
...
# Xpath extraction
_xpath = '//*[@id="node-106279"]/div[1]/div[1]/div/div/div/div/p[2]/a[contains(@href,"http")]/text()'
